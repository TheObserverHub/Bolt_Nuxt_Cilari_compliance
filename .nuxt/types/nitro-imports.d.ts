declare global {
  ...
  const generateToken: typeof import('../../server/utils/db')['generateToken']
  ...
  const hashPassword: typeof import('../../server/utils/db')['hashPassword']
  ...
  const verifyPassword: typeof import('../../server/utils/db')['verifyPassword']
...
export { default as db, hashPassword, verifyPassword, generateToken } from '../../server/utils/db';