/*
  # Module 1: Data Protection and Confidentiality Content

  1. Content Added
    - Understanding Data Protection and Confidentiality section
    - Best Practices section
    - Data Breaches and Reporting section
...
DECLARE
  module1_id uuid;
BEGIN
  -- Get the ID of Module 1
  SELECT id INTO module1_id FROM modules WHERE order_number = 1;

  -- Insert sections for Module 1
  INSERT INTO sections (module_id, title, content, order_number, type) VALUES
  -- Section 1: Understanding Data Protection and Confidentiality
  (
    module1_id,
